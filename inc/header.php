<?php
 include dirname(__FILE__) . DIRECTORY_SEPARATOR .'../lib/Session.php';
 Session::init();
 include dirname(__FILE__) . DIRECTORY_SEPARATOR .'../lib/Database.php';
 include dirname(__FILE__) . DIRECTORY_SEPARATOR .'../helpers/Format.php';
